...
public abstract class Hilt_CalibrationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CalibrationFragment() {
    super();
  }

  Hilt_CalibrationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CalibrationFragment_GeneratedInjector) this.generatedComponent()).injectCalibrationFragment(UnsafeCasts.<CalibrationFragment>unsafeCast(this));
    }
  }
