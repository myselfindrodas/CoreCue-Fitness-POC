...
public abstract class Hilt_RecordingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecordingFragment() {
    super();
  }

  Hilt_RecordingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecordingFragment_GeneratedInjector) this.generatedComponent()).injectRecordingFragment(UnsafeCasts.<RecordingFragment>unsafeCast(this));
    }
  }
