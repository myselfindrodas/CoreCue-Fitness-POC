...
public abstract class Hilt_DemoVideoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DemoVideoFragment() {
    super();
  }

  Hilt_DemoVideoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DemoVideoFragment_GeneratedInjector) this.generatedComponent()).injectDemoVideoFragment(UnsafeCasts.<DemoVideoFragment>unsafeCast(this));
    }
  }
